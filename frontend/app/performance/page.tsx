...
function Grade({
  ...
  const dot = { good: "bg-amber-400", ok: "bg-amber-400", bad: "bg-rose-400", neutral: "bg-slate-600" }[tone]
  return (
      ...
      {hasClv ? (
        <div className="grid grid-cols-2 gap-3">
          <div>
            ...
            <p className={`font-mono text-[20px] tabular-nums font-bold ${(stats.avg_clv ?? 0) > 0 ? "text-amber-400" : "text-rose-400"}`}>
  ...
  return (
    <>
      ...
      <div className="max-w-3xl mx-auto px-3 sm:px-5 py-5">
        {/* hero */}
        <div className="mb-6">
          <p className="text-[11px] font-bold uppercase tracking-[0.2em] text-amber-400/80">Graded in public</p>
            ...
            {stats && stats.total > 0 ? (
              <div className="grid grid-cols-3 gap-3">
                ...
                <div>
                  ...
                  <p className={`font-mono text-[20px] tabular-nums font-bold ${(stats.roi ?? 0) >= 0 ? "text-amber-400" : "text-rose-400"}`}>
        ...
        <p className="text-[11px] text-slate-500 mt-5 leading-relaxed">
          ...
          <a href="/how-it-works" className="text-amber-400 hover:underline">How it works</a>.
        </p>
      </div>
    </>
  )
